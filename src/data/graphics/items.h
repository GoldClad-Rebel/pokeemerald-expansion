...
const u32 gItemIcon_Purse[] = INCBIN_U32("graphics/items/icons/birchs_bag_icon.4bpp.lz");
const u32 gItemIconPalette_Purse[] = INCBIN_U32("graphics/items/icon_palettes/birchs_bag_icon.gbapal.lz");
