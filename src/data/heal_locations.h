static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_RUSTBORO_CITY - 1] = {MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY), 33, 21},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 15, 7},
    ...
    [HEAL_LOCATION_PETALBURG_FOREST - 1] = {MAP_GROUP(PETALBURG_FOREST), MAP_NUM(PETALBURG_FOREST), 16, 11},
};
